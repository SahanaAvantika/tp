...
public class EditCommand extends Command {
    ...
    private static Student createEditedPerson(Student personToEdit, EditPersonDescriptor editPersonDescriptor) {
        ...
        Name updatedStudentName = editPersonDescriptor.getStudentName().orElse(personToEdit.getStudentName());
        ...
        return new Student(updatedStudentName, updatedStudentId, updatedParentName, updatedPhone, updatedEmail, updatedAddress);
    }
    ...
    public static class EditPersonDescriptor {
        ...
        public boolean isAnyFieldEdited() {
            return CollectionUtil.isAnyNonNull(studentName, studentId, parentName, phone, email, address);
        }
